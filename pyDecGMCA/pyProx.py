...
# Proximal operators
##########################################################################
def update_S_prox_peusdo_anal(V, A, S, M, Nx, Ny, Ndim, Imax, mu, Ksig, mask, wavelet, scale, wname='starlet',
                              thresStrtg=2, FTPlane=True, Ar=None, FISTA=False, PALM=False, currentIter=0,
                              globalImax=1):
    """
    ...
    @param PALM: PALM algorithm, default is false

    @param currentIter: current iteration, default is 0

    @param globalImax: outer iteration, default is 1
...
def update_S_prox_anal(V, A, S, M, Nx, Ny, Ndim, Imax, ImaxInt, mu, muInt, Ksig, wavelet, scale, wname='starlet',
                       thresStrtg=2, FTPlane=True, Ar=None, FISTA=False, PALM=False, currentIter=0, globalImax=1,
                       u=None, sig=None):
    """
