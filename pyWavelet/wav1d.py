...
def scaleFilter(wname, wtype):
    if wtype == 1:
        ...
        if wname == '9/7' or wname == 'bior4.4':
            ...
            Df = np.array([-5. / 1024, 5. / 512, 17. / 512, -39. / 512, -123. / 1024, 81. / 256, 175. / 256, 81. / 256,
                           -123. / 1024, -39. / 512, 17. / 512, 5. / 512, -5. / 1024])
            Rf = np.array([1. / 4, 1. / 2, 1. / 4])
        elif wname == 'bior2.8':
            Df = 1. / (2 ** 15) * np.array(
                [35, -70, -300, 670, 1228, -3126, -3796, 10718, 22050, 10718, -3796, -3126, 1228, 670, -300, -70, 35])
            Rf = np.array([1. / 4, 1. / 2, 1. / 4])
        elif wname == 'bior3.1':
            Df = 1. / 4 * np.array([-1, 3])
            Rf = 1. / 8 * np.array([1, 3])
